package com.igding.practiccustomview.activity.hencoder4;
...
public class HencoderPractic4Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.string.title_camera_rotate_fixed, R.layout.practice_measure_text4));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hencoderpractic4);
